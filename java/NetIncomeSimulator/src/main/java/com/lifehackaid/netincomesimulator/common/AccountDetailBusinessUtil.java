...
public class AccountDetailBusinessUtil {
	...
	public static List<AccountDetailForm> createDefaultAccountDetailFormList() {
		...
		accountDetailFormList.add(new AccountDetailForm(AccountCategories.NecessaryExpenses, "消費税納付(簡易課税)", 35000L,12L, false));
		...
		accountDetailFormList.add(new AccountDetailForm(AccountCategories.IncomeDeduction, "IDeCo", 20000L,12L, false));
		accountDetailFormList.add(new AccountDetailForm(AccountCategories.IncomeDeduction, "小規模企業共済", 20000L,12L, false));
